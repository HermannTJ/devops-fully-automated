...
1) ###### GitHub setup
    Fork GitHub Repository by using the existing repo "devops-fully-automated" (https://github.com/HermannTJ/devops-fully-automated.git)     
    - Go to GitHub (github.com)
    - Login to your GitHub Account
    - **Fork repository "devops-fully-automated" (https://github.com/HermannTJ/devops-fully-automated & name it "devops-fully-automated"**
...
2) ###### Jenkins/Maven/Ansible
    ...
    - User data (Copy the following user data): https://github.com/HermannTJ/devops-fully-automated-scripts/blob/main/jenkins-maven-ansible-setup.sh
    - Launch Instance
...
3) ###### SonarQube
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/HermannTJ/devops-fully-automated-scripts/blob/main/sonarqube-setup.sh
    - Launch Instance
...
4) ###### Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/HermannTJ/devops-fully-automated-scripts/blob/main/nexus-setup.sh
    - Launch Instance
...
5) ###### EC2 (Dev/Stage/Prod)
    ...
    - Security Group (Open): 8080, 9100 and 22 to 0.0.0.0/0
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/HermannTJ/devops-fully-automated-scripts/blob/main/deployment-servers-setup.sh
    - Launch Instance
...
6) ###### Prometheus
    ...
    - User data (Copy the following user data): https://github.com/HermannTJ/devops-fully-automated-scripts/blob/main/prometheus-setup.sh
    - Launch Instance
...
7) ###### Grafana
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/HermannTJ/devops-fully-automated-scripts/blob/main/grafana-setup.sh
    - Launch Instance
